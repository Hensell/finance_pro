...
class ShareModePicker extends StatelessWidget {
  const ShareModePicker({
    required this.modes,
  ...
  Widget build(BuildContext context) {
    ...
    return DsReadingSection(
      title: context.l10n.shareCalculatorModelSectionTitle,
      summary: context.l10n.shareCalculatorModelSectionSummary,
      child: Column(
